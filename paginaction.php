 ...
 <body>
  ...
  <div class="container">
   ...
   <div class="table-responsive">
    ...
    if($page > 1){
     echo "<a href='paginaction.php?page=1'>First</a>";
     echo "<a href='paginaction.php?page=".($page - 1)."'><<</a>";
    }
    for($i=1; $i<=$end_loop; $i++)
    {     
     echo "<a href='paginaction.php?page=".$i."'>".$i."</a>";
    }
    if($page <= $end_loop){
     echo "<a href='paginaction.php?page=".($page + 1)."'>>></a>";
     echo "<a href='paginaction.php?page=".$total_pages."'>Last</a>";
    }
